...
const student: Student = {
  age: 17,
  address: "Jl. Setiabudi budi",
  name: "Jamal",
  hobby: ["Mancing", "Basket", "Badminton"],
};
...
// ================================ FUNCTION SCOPE ==========================
// variable yang di define didalam function, hanya bisa diakses didalam func tsb
...
// ======================= PARAMETER & ARGUMEN =============================
// parameter --> variable yang mewakili value dari argumment yang dimasukkan
...
// inner function bisa mengakses dari outer function
...
// ======================== RECURSIVE =============================
// fungsi yang memannggil dirinya sendiri
...
// kalo misalnya cuma satu bisa disingkat kaya dibawah
...
// PUSH --> menambahkan value ke paling akhir
const words5: string[] = ["hello", "world", "test"];
words5.push("siti");
console.log(words5);

// SPLICE --> untuk menghapus, mengganti, atau menambahka value pada sebuah array
// rumus --> splice(startIndex, brpYngMaudiDidelete,  item)
...
// SLICE --> mereturn array babru berdasarkan start index dan end index
// rumus --> slice(startIndex, endIndex)
const fruits2: string[] = ["apple", "banana", "orange", "mango", "lemon"];
console.log(fruits2.slice(1, 4));

// INDEXOF --> mencari index dari value ynag kita cari kalau tidak ditemukan maka akn mereturn -1
...
const fruits4: string[] = ["banana", "apple", "orange", "mango", "lemon"];
fruits4.sort();
console.log(fruits4);

const points: number[] = [2, 5, 3, 10, 8];
points.sort((a, b) => a - b); // asc (kecil besar)
console.log(points);

points.sort((a, b) => b - a); // asc (kecil besar)
...
const fruits5: string[] = ["banana", "apple", "orange", "mango", "lemon"];
...
// FOREACH --> melakukan looping pada array tapi tidak meretur array baru
const fruits6: string[] = ["banana", "apple", "orange", "mango", "lemon"];
