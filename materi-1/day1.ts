...
const name: string = "BuIdi";
const name2: string = "Bara";
...
// console.log(2 === "2") // pengecekan di value dan type datanya
console.log(2 < 5);
console.log(5 < 2);
console.log(5 <= 5);
console.log(5 >= 5);
...
//console.log(b); // ini gak bisa karena tidak termasuk dalam hoisting
//let b;
